...
urlpatterns = [
    ...
    url(r'^kassenbuch/$', views.reportumsaetze_redirect, name='kassenbuch_redirect'),
    ...
    url(r'^bericht/$', views.bericht_redirect, name='bericht_redirect'),
    ...
    url(r'^sortierung$', views.sortierung_aendern, name='sortierung'),
]
